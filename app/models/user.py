...
class User(Base):
    ...
    # ── Trainer-related relationships ──
    trainer_profile = relationship("Trainer", back_populates="user", uselist=False, cascade="all, delete-orphan")
    trainer_bookings = relationship("TrainerBooking", back_populates="member", cascade="all, delete-orphan")
    trainer_reviews = relationship("TrainerReview", back_populates="member", cascade="all, delete-orphan")
